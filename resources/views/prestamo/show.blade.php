        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
                <div class="p-6 text-gray-900">
                    <h2 class="flex items-center text-3xl font-semibold text-gray-700 mb-5">Mis préstamos</h2>
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                ...
                                <!--Si la fecha de devolucion es nula y el id del usuario del prestamo es igual al id del usuario que está logueado-->
